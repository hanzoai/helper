...
> Sign in to Zen and use its AI models in Claude Code, Codex, and more.
...
See the [upstream README](https://github.com/hanzoai/helper) for the full
command reference. License: Apache-2.0.
